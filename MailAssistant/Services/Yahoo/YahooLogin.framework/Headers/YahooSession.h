...
- (void)didFailAuthoriaztion:(NSError *)error;
- (void)didCancelLogin;
 ...
 */
@interface YahooSession : NSObject
 ...
 * @param consumerKey		The OAuth consumer key assigned to the application.
 * @param consumerSecret	The OAuth consumer secret assigned to the application.
 * @param applicationId	The application ID to identify this session.
 ...
 * 
 * @param oAuthConsumer	The OAuth consumer for your application.
 * @param applicationId	The application ID to identify this session.
 * @return					The initialized session.
 * @see YOAuthConsumer
 */
